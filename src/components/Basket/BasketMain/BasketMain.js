...
import { updateBasket, removeFromBasket, removeBasket, deleteBasketItem } from '../../../Store/reducers/BasketReducer'
                ...
                <div className='basket_parent_area_pr'>
                        ...
                        {productsBas?.map((product) => (
                            <div key={product?.id} id={product?.id} className="basket_product_area">
                                <div onClick={() => {
                                    ...
                                    {product?.variant?.assets?.length > 0 ? <img key={product?.variant?.assets?.[0]?.id} src={product?.variant?.assets?.[0]?.url} alt="product_img" /> : <img src={product?.image?.url} alt="product_img" />}
                                </div>
                                <div className="basket_product_about">
                                    ...
                                    <div className="row">
                                        <div className="color_and_size">
                                            ...
                                            {product?.selected_options.length > 0 ? <><h3 className="color"><span>{product?.selected_options?.[1]?.group_name}: </span>{product?.selected_options?.[1]?.option_name}</h3>
                                                <h3 className="size"><span>{product?.selected_options?.[0]?.group_name}: </span>{product?.selected_options?.[0]?.option_name}</h3></> : null}

                                            {product?.selected_options.length > 0 ? <h3 className="price">{product?.selected_options?.[0]?.price?.raw} AZN</h3> : <h3 className="price">{product?.price?.raw} AZN</h3>}
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="checkout_area">
                        ...
                        <div className="all_expense_area">
                            ...
                            } <img src={azn} alt="money" /></h3>
                        </div>
                        <div className="all_expense_area">
                            <h3 className="all_expense">Çatdırılma</h3>
                            <h3 className="money">0 <img src={azn} alt="azn" /></h3>
                        </div>
                        <div className="all_expense_area">
                            <h3 className="all_expense">Hədiyyə paketi</h3>
                            <h3 className="money">0 <img src={azn} alt="azn" /></h3>
                        </div>
                        <div className="all_expense_area">
                            <h3 className="all_expense">Promo kod</h3>
                            <h3 className="money">0 <img src={azn} alt="azn" /></h3>
                        </div>
                        <div className="all_expense_area">
                            <h3 className="all_expense">Cəmi</h3>
                            <h3 className="money total">{total?.reduce((a, b) => a + b)} <img src={total1} alt="azn" /></h3>
                        </div>
                    </div>
                </div>}
            <ToastContainer />
